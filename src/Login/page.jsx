...
export default function LoginPage({ setUser, setUserId, setSpecialty, setIsAuthenticated }) {
  ...
  return (
    <div className="container-sm my-5 pt-5" style={{ backgroundColor: 'rgba(0, 43, 122, 0.8)', borderRadius: '25px', minHeight: '30vh', maxHeight: '70vh', maxWidth:'60vh' , overflowY: 'auto', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.5)' }}>
      <div className="row align-items-center mt-3 pt-3" style={{ height: '100%', overflowY: 'auto' }}>
        <svg xmlns="http://www.w3.org/2000/svg" height="120px" viewBox="0 -960 960 960" width="18px" fill="#e8eaed" style={{ maxHeight: '100%' }}>
        ...
        <div className="container pt-3" style={{ flex: 1, overflowY: 'auto' }}>
          <div className="col d-flex align-items-center justify-content-center my-4 pt-4" style={{ flexDirection: 'column' }}>
            <form onSubmit={handleSubmit} style={{ width: '100%', maxWidth: '100%' }}>
              
              <label htmlFor="exampleFormControlInput1" className="form-label  d-flex align-items-center justify-content-center text-white responsive-text">Usuario</label>
              <div className="mb-3 d-flex align-items-center justify-content-center">
                <input
                  ...
                  style={{ maxWidth: '50%', borderRadius:'25px' }}
                />
              </div>


              <div className="mb-3">
                <label htmlFor="inputPassword" className="form-label  d-flex align-items-center justify-content-center text-white responsive-text">Contraseña</label>
                <div className="mb-3 d-flex align-items-center justify-content-center">
                  <input
                    type="password"
                    className="form-control"
