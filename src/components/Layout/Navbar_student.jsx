...
export default function NavbarStudent({ userId }) {
    ...
    <div>
      <nav className="navbar" style={{ backgroundColor: '#EFCA45' }}>
        <div className="container-fluid">
          {/* Primera lista de elementos (lado izquierdo) */}
          <ul className="nav nav-underline">

            <li className="nav-item"> {/* BOtón para ir a la agenda */}
              <Link
            ...
            <li className="nav-item"> {/* BOtón para ver las sesiones */}
              <Link 
            ...
            <li className="nav-item">  {/* BOtón para ver los eventos */}
              <Link
          ...
          <ul className="nav justify-content-end align-items-center">
            ...
            <li className="nav-item"> {/* BOtón para cerrar sesión */}
              <button onClick={handleLogout} className="navbar-brand" style={{ background: 'none', border: 'none' }}>
                <svg xmlns="http://www.w3.org/2000/svg" height="38px" viewBox="0 -950 960 960" width="38px" fill="#3A2E01"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h280v80H200v560h280v80H200Zm440-160-55-58 102-102H360v-80h327L585-622l55-58 200 200-200 200Z"/></svg>
              </button>
            </li>
